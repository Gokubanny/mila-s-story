...
function createSupabaseClient() {
	const SUPABASE_URL = {
		...
		"VITE_SUPABASE_PROJECT_ID": "jttqifsdqebnrxdbwyjx",
		"VITE_SUPABASE_PUBLISHABLE_KEY": "sb_publishable_w65IVUqT0oDCa5gsJ2SBvA_ic8TLZJq",
		"VITE_SUPABASE_URL": "https://jttqifsdqebnrxdbwyjx.supabase.co"
